...
public class studentsController1 implements Initializable {
    @FXML
    ...
    public void setData (ActionEvent event) {
        try{
            ...
            ResultSet rs = conn.createStatement().executeQuery("SELECT Name, Science, Maths, English, PT, SocialScience FROM students WHERE Name LIKE 'hi'");
            while(rs.next()){
